...
import { addProductToCart, removeSingleProductToCart } from "../action/action";
...
export const ItemCard = ({ product, quantity }: Props) => {
    ...
    function onRemoveItem() {
        removeSingleProductToCart(product.id)
        router.refresh();
    }
        ...
        <div className="flex items-center shadow rounded-lg w-full bg-gray-800 border-gray-100">
            ...
            <div className="flex p-5 items-center justify-center">
                ...
                <button
                    ...
                    className=" bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                    <IoRemove size={25} />
                </button>
            </div>
        </div>
